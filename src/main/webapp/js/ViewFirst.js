...
(function() {
  ...
  define('ViewFirstModel',["underscore", "jquery", "Property", "ViewFirstEvents"], function(_, $, Property, Events) {
...
(function() {
  ...
  define('ViewFirst',["ViewFirstModel", "ViewFirstRouter", "ViewFirstModelContainer", "BindHelpers", "TemplatingSnippets", "OneToMany", "ManyToOne"], function(ViewFirstModel, ViewFirstRouter, ModelContainer, BindHelpers, TemplatingSnippets, OneToMany, ManyToOne) {
    var ViewFirst;
